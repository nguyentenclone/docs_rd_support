...
- [6.Quản lý user](coupon/6qlyuser.md)
	- [6.1 Thêm user vào kho](coupon/61adduservaokho.md)
	- [6.2 Gia hạn giới hạn tạo kho cho user có sẵn](coupon/62giahan.md)
	- [6.3 Add user vào quản lý kho quà](coupon/63adduserqly.md)
- [7.Gạch code](coupon/7gachcode.md)
